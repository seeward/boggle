...
var randomEncouragement = function () {
...
var isAdjacent = function (prevLetter, currLetter) {
    // get both indexs
    var prevIndex = findIndexs(prevLetter);
    var currIndex = findIndexs(currLetter);
    // check if they are adjacent by index
...
var isAdjacentDiceFromIndex = function (currentIndex, prevIndex) {
    ...
    return check;
    // return workCheckMap[prevIndex].contains(currentIndex)
};
var findIndexs = function (val) {
    var indexes = [], i;
...
var walkWord = function (word) {
    var wordAsArray = __spreadArrays(word);
    return recursiveLoop(wordAsArray);
};
var recursiveLoop = function (wordArray) {
